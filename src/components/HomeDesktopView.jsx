        ...
        <div className='greatVibesRegular'>
            ...
            <div id='divBuffet' className='flex text-3xl'>
                ...
                <div className='relative w-2/3 overflow-hidden'>
                    ...
                    <img src={capaBuffet} alt='imagem de carne cortada' className='w-full h-auto translate-x-full img' />
                ...
                <div className='w-1/2 xl:w-1/3 xl:px-2 flex items-center justify-center'>
                    <p className='text text-justify p-[18px] bg-zinc-800 xl:rounded-md overflow-visible xl:relative xl:right-14 shadow-sm shadow-zinc-950 opacity-0'>
            ...
            <div id='divSalao' className='text-3xl flex'>

                <div className='w-2/5 xl:w-1/3 xl:px-2 flex items-center z-10 '>
                    <p className='text text-justify p-5 bg-zinc-800 xl:rounded-md overflow-visible xl:relative xl:left-14 opacity-0'>
                ...
                <div className='w-2/3 relative overflow-hidden'>
                    ...
                    <img src={capaSalao} alt='foto do salão de festa' className='w-full h-auto lg:max-xl:h-full opacity-0 -translate-x-full img' />
