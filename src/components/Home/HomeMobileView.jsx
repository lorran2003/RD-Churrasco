...
export default function HomeMobileView({ handleClickBuffet, handleClickSalao }) {
    return (
        <div className='fontTimes pt-1'>
            ...
            before:block before:bg-[#D70319] before:h-1 before:w-1/4 before:sm:w-2/6
            after:block after:bg-[#D70319] after:h-1 after:w-1/4 after:sm:w-2/6">
            ...
            <div className='px-4 py-16'>
                ...
                <div className="p-3 sm:p-5 flex items-center justify-between bg-zinc-800 rounded-md">
                    ...
                    <button type='button' aria-label='acessar a pagina buffet' className="bg-zinc-50 text-zinc-800 text-xl sm:text-3xl p-1 rounded-md animate-bounce border-2 border-solid border-zinc-950" onClick={handleClickBuffet}>
                ...
                <div className='flex flex-col gap-2 py-2'>
                    <div className='bg-zinc-800 rounded-sm p-2 sm:p-4'>
                        <img src={capaBuffet} alt='imagem de carne cortada' className='w-full h-auto rounded-md border-solid border-2 border-[#D70319] shadow-md shadow-zinc-950' />
                    </div>

                    <button type='button' aria-label='solicitar orçamento' className="rounded-md bg-[#3FE05C] text-zinc-50 text-xl sm:text-4xl w-full py-1 sm:py-2 animate-pulse border-2 border-solid border-zinc-50" >
                    ...
                    <div className="bg-zinc-800 p-3 sm:py-8 rounded-md border-2 border-solid border-zinc-50/30" >
            ...
            <div className='px-4 pb-16'>
                ...
                <div className="p-3 flex items-center justify-between bg-zinc-800 rounded-md">
                    ...
                    <button type='button' aria-label='acessar a pagina do salão' className="bg-zinc-50 text-zinc-800 text-xl sm:text-3xl p-1 rounded-md animate-bounce border-2 border-solid border-zinc-950" onClick={handleClickSalao}>
                ...
                <div className='flex flex-col gap-2 py-2'>
                    ...
                    <div className='bg-zinc-800 rounded-sm p-2 sm:p-4 '>
                        <img src={capaSalao} alt='Foto do salão de festa' className='w-full h-auto rounded-md border-solid border-2 border-[#D70319] shadow-md shadow-zinc-950' />
                    </div>
                    ...
                    <div className="rounded-md bg-zinc-800 p-3 sm:py-8 border-2 border-solid border-zinc-50/30" >
                        <p className='text-lg sm:text-2xl ' >
